  ...
  return (
    <div className="container my-5" style={{ maxWidth: '800px' }}>
      <div className="card shadow-sm p-4 rounded-4">
        <h2 className="text-center text-danger mb-4">Student Information</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="row g-3">
            ...
            <div className="col-md-4">
              ...
              <input type="date" name="birth_date" className="form-control rounded-3" onChange={handleChange} required />
            </div>
            <div className="col-md-4">
              <label>Age</label>
            ...
            <div className="col-12">
              ...
              <input type="text" name="home_address" className="form-control rounded-3" onChange={handleChange} required />
            </div>
            <div className="col-md-6">
            ...
            <div className="col-md-6">
              ...
              <select name="is_4ps" className="form-select rounded-3" onChange={handleChange} required>
                <option value="">Select</option>
          ...
          <h5 className="text-primary mt-4 mb-3">Family Information</h5>
          <div className="row g-3">
            <div className="col-md-4">
              <label>Father's Name</label>
              <input type="text" name="father_name" className="form-control rounded-3" onChange={handleChange} />
            </div>
            <div className="col-md-4">
              <label>Mother's Name</label>
              <input type="text" name="mother_name" className="form-control rounded-3" onChange={handleChange} />
            </div>
            <div className="col-md-4">
              <label>Guardian Name</label>
              <input type="text" name="guardian_name" className="form-control rounded-3" onChange={handleChange} />
            </div>
          </div>
          ...
          <div className="row g-3">
            <div className="col-md-4">
              <label>Name</label>
              <input type="text" name="emergency_contact_name" className="form-control rounded-3" onChange={handleChange} required />
            </div>
            <div className="col-md-4">
              <label>Relationship</label>
              <input type="text" name="emergency_relationship" className="form-control rounded-3" onChange={handleChange} required />
            </div>
            <div className="col-md-4">
              <label>Phone Number</label>
              <input type="text" name="emergency_phone" className="form-control rounded-3" onChange={handleChange} required />
            </div>
            <div className="col-12">
              <label>Address</label>
              <input type="text" name="emergency_address" className="form-control rounded-3" onChange={handleChange} required />
            </div>
          </div>
